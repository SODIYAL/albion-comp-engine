...
736 rows compared, 435 moved; median |relative move| 0.004, p90 0.063
...
| clap_kite/10-14/requirements/max_health_cut/soft_cap | 1.95 | 1.61 |
| brawl/10-14/requirements/silence/soft_cap | 17.48 | 20.5 |
| brawl_clap/10-14/requirements/silence/soft_cap | 17.48 | 20.5 |
...
- 7 pooled -> pooled, e.g. 2H_BOW:head HEAD_LEATHER_SET3(0)->HEAD_PLATE_SET1(2), 2H_CURSEDSTAFF:head HEAD_LEATHER_SET3(0)->HEAD_PLATE_SET3(0)
...
- 3 own evidence 30+ votes (meta shift or noise), e.g. 2H_HOLYSTAFF_CRYSTAL:food T7_MEAL_OMELETTE(81)->T7_MEAL_OMELETTE_AVALON(68), 2H_KNUCKLES_HELL:head HEAD_PLATE_SET1(32)->HEAD_LEATHER_SET3(44)
...
- 11 pooled -> pooled, e.g. 2H_BOW_CRYSTAL:head HEAD_PLATE_SET1(2)->HEAD_LEATHER_SET3(2), 2H_BOW_CRYSTAL:shoes SHOES_LEATHER_AVALON(0)->SHOES_LEATHER_MORGANA(2)

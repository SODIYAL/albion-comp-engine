...
**Still parked behind review**: ANY empirical/scoring integration beyond the two owner-ruled uses above and the harvest-generated meta prior (solo 2026-09-08, best-observed-partner 2026-09-11 — derived from the official-API killer-party channel `out/party_rosters.json`, never from this cohort channel; standing rule 7). Neighbours, families, roster mixes and quotas aggregate nothing into a score, a suggestion pool, or the forge's objective, and must stay that way without an explicit owner ruling.

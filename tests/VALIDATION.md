...
| 09-12 | Forge quality sweep (report-only, `pipeline/audit_forge_quality.py`): 72 cells forged whole and graded — feasible everywhere, roles inside the harvest band 58/60, kill lights green 71/72; but kite reads clap in 10/13 kite cells and brawl_clap never reads brawl_clap, one core recurs across styles (Fists of Avalon in 56/60 cells at <= 11.5% prevalence), catch past the soft cap in 27/72, 25-man forges 6-7 healers, and a refresh alternative outscores the button in 25/72 cells. Nothing retuned; grading form issued | audit + form | — | notes/findings/2026-09-12-forge-quality-findings.md |
